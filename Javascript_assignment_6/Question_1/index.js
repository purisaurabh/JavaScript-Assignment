...
function filterByName(nameValue) {
  ...
  let nameArr = arrObject.filter((user) => user.first_name.includes(nameValue));

  return nameArr;
}
const result = filterByName("Sam");
console.log("Array object filter by name : ", result);
// Output :
/*
  Array object filter by name :  [
  {
    id: 8,
    first_name: 'Sam',
    email: 'scorck7@sitemeter.com',
...
console.log("Emails array is : ", emailsArr);
/*
Output : 
Emails array is :  [
...
function getByIdUsingFilter(id) {
  let res = arrObject.filter((value) => value.id === id);
...
/*
The array by id using the filter : [
  {
    id: 1,
    first_name: 'Nicki',
    email: 'ncrozier0@squarespace.com',
...
/*
The array by id using the for loop : {
  id: 3,
  first_name: 'Demetris',
  email: 'dkilshall2@elpais.com',
  date_of_birth: '2018/12/31'
